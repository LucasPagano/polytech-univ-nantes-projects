...
public class Hungarian implements DecisionAlgorithm{

    //********************************// 
    //METHODS FOR CONSOLE INPUT-OUTPUT// 
    //********************************// 
	public int[][] decide(double[][] mat) {
		return hgAlgorithm(mat, "max");
	}
    ...
    */
    ...
    public static void main(String[] args){
        ...
        int[][] assignement = hgAlgorithm(array, "max");
        for(int i = 0; i < assignement.length; i++){
        	for(int j = 0; j < assignement[i].length; j++){
            	System.out.print(assignement[i][j] + " ");
        	}
        	System.out.print(", ");
        }
